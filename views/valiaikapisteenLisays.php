    ...
    <form class="form-horizontal" role="form" action="valiaikapiste.php" method="POST">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <button name="lisattava" type="submit" class="btn btn-default">Lisää väliaikapiste</button>
				<button type="submit" class="btn btn-default" formaction="valiaikapiste.php?valiaika=<?php echo $kilpailutunnus; ?>">Palaa takaisin</button>
            </div>
        </div>
    </form>

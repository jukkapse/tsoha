    ...
    <form class="form-horizontal" role="form" action="lisaaValiaikapiste.php" method="POST">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <button name="submit" type="submit" class="btn btn-default">Lisää väliaikapiste</button>
				<button type="submit" class="btn btn-default" formaction="valiaikapisteet.php?valiaika=<?php echo $kilpailuid; ?>">Palaa takaisin</button>
            </div>
        </div>
    </form>
